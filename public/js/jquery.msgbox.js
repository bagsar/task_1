...
(function($, undefined){
	...
	if ($(window).width()>736){scrleft= ($(window).width()-800)/2}else{scrleft=0}
	var DEFAULTS = {
		...
		top: 62,			// the position of msgbox, if false, will show in the middle of the window
		left: scrleft,
